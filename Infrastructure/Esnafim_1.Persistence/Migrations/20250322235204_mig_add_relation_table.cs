...
namespace Esnafim_1.Persistence.Migrations
{
    ...
    public partial class mig_add_relation_table : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BusinessCategoryRelations",
                columns: table => new
                {
                    BusinessCategoryRelationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusinessCategoryId = table.Column<int>(type: "int", nullable: false),
                    BusinessId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessCategoryRelations", x => x.BusinessCategoryRelationId);
                    table.ForeignKey(
                        name: "FK_BusinessCategoryRelations_BusinessCategories_BusinessCategoryId",
                        column: x => x.BusinessCategoryId,
                        principalTable: "BusinessCategories",
                        principalColumn: "BusinessCategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessCategoryRelations_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessOwnershipId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusinessOwnerId = table.Column<int>(type: "int", nullable: false),
                    BusinessId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessOwnerships", x => x.BusinessOwnershipId);
                    table.ForeignKey(
                        name: "FK_BusinessOwnerships_BusinessOwner_BusinessOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEmployeeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    BusinessId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessEmployees_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerArrive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSpam = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessComments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessCategoryRelations_BusinessCategoryId",
                table: "BusinessCategoryRelations",
                column: "BusinessCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessCategoryRelations_BusinessId",
                table: "BusinessCategoryRelations",
                column: "BusinessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessComments_UserId",
                table: "BusinessComments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessOwnerships_BusinessOwnerId",
                table: "BusinessOwnerships",
